...
export default class Team {
  ...
  isValidForCreate() {
    ...
    if (this.teamname === null) {
      ...
      errors["teamNameMinLength"] =
        "Team name cannot have less than 5 characters";
      hasErrors = true;
    } else if (this.teamname.trim().length > 20) {
      errors["teamNameMaxLength"] =
        "Team name cannot have more than 20 characters";
      hasErrors = true;
    }
    ...
    if (this.userLeader.length === null) {
      ...
      errors["userLeaderMaxLength"] =
        "User Leader cannot have more than 20 characters";
      hasErrors = true;
    }

    if (
      parseInt(this.isPrivate, 10) !== 0 &&
      parseInt(this.isPrivate, 10) !== 1
    ) {
    ...
    if (this.description === null) {
      ...
      errors["teamDescriptionMaxLength"] =
        "Description cannot have more than 512 characters";
      hasErrors = true;
    } else if (this.description.trim().length < 5) {
      errors["teamDescriptionMinLength"] =
        "Description cannot be less than 5 characters";
      hasErrors = true;
    }

    if (this.maxNumberPlayers === null) {
      errors["maxNumberPlayersNull"] =
        "The maximum number of players cannot be null";
      hasErrors = true;
    } else if (this.maxNumberPlayers < 2) {
      errors["maxNumberPlayersMinSize"] =
        "The maximum number of players cannot be less than 1";
      hasErrors = true;
    } else if (this.maxNumberPlayers > 25) {
      errors["maxNumberPlayersMaxSize"] =
        "The maximum number of players cannot be greater than 25";
      hasErrors = true;
    }
    ...
    if (this.createDate === null) {
      ...
      new Date(this.date) > tomorrow ||
      new Date(this.date) < yesterday
    ) {
  ...
  isValidForUpdate() {
    ...
    if (this.description === null) {
      ...
      error["teamDescriptionMaxLength"] =
        "Description cannot have more than 512 characters";
      hasErrors = true;
    } else if (this.description.length < 5) {
      error["teamDescriptionMinLength"] =
        "Description cannot be less than 5 characters";
      hasErrors = true;
    }
