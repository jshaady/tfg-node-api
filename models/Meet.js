...
export default class Meet {
  ...
  isValidForCreate() {
    ...
    if (this.sport === null) {
      ...
      errors["meetSportMaxLength"] =
        "Sport cannot have more than 25 characters";
      hasErrors = true;
    ...
    if (this.description === null) {
      ...
      errors["meetDescriptionMaxLength"] =
        "Description cannot have more than 512 characters";
      hasErrors = true;
    } else if (this.description.length < 5) {
      errors["meetDescriptionMinLength"] =
