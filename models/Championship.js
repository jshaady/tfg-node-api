...
class Championship {
     ...
     */
    constructor(id = null, championshipName = null, creatorUser = null, numMaxTeams = null, startInscription = null, endInscription = null,
        startChampionship = null, location = null, sport = null, type = null, state = null, phase = null, description = null) {
        this.id = id;
    ...
    isValidForCreate() {
        ...
        if (this.championshipName === null) {
            ...
            errors["championshipNameMinLength"] = "Tournament name cannot have less than 5 characters";
            hasErrors = true;
        } else if (this.championshipName.length > 60) {
            errors["championshipNameMaxLength"] = "Tournament name cannot have more than 60 characters";
            hasErrors = true;
        }
        ...
        if (this.type === null) {
            ...
            if (this.numMaxTeams != "4" && this.numMaxTeams != "10" && this.numMaxTeams != "20") {
                errors["numMaxTeamsIncorrect"] = "Incorrect maximum number of teams";
                hasErrors = true;
            }
        } else if (this.type === 'Tournament') {
            if (this.numMaxTeams != "4" && this.numMaxTeams != "8" && this.numMaxTeams != "16" && this.numMaxTeams != "32") {
                errors["numMaxTeamsIncorrect"] = "Incorrect maximum number of teams";
                hasErrors = true;
            }
        }
        ...
        if (this.description === null) {
            ...
            errors['descriptionMinLength'] = "Description cannot have less than 5 characters";
            hasErrors = true;
        ...
        if (this.location === null) {
            ...
            errors["championshipLocationMaxLength"] = "Location cannot have more than 255 characters";
            hasErrors = true;
        ...
        if (this.startInscription === null) {
            ...
            errors['startInscriptionIncorrect'] = "Start inscription date is incorrect";
            hasErrors = true;
        }
        ...
        if (this.endInscription === null) {
            ...
            hasErrors = true;
        } else if (isNaN(endInscription.getTime()) || endInscription <= startInscription) {
            errors['endInscriptionIncorrect'] = "End inscription date is incorrect";
            hasErrors = true;
        }

        if (this.startChampionship === null) {
            errors['startChampionshipNull'] = "Start championship date cannot be null";
            hasErrors = true;
        } else if (isNaN(startChampionship.getTime()) || startChampionship <= startInscription || startChampionship <= endInscription) {
            errors['startChampionshipIncorrect'] = "Start championship date is incorrect";
            hasErrors = true;
        }
