...
export default class User {
  ...
  isValidForCreate() {
    ...
    if (this.username == null) {
      ...
      errors["userNameMinLength"] =
        "Username cannot have less than 4 characters";
      hasErrors = true;
    } else if (this.username.length > 20) {
      errors["userNameMaxLength"] =
    ...
    if (this.birthdate == null) {
      ...
      new Date(
        parseInt(fechaSplit[0]) + 18,
        parseInt(fechaSplit[1]) - 1,
        parseInt(fechaSplit[2])
      ) > new Date()
    ) {
  ...
  isValidForUpdate() {
    ...
    if (this.surname === null) {
      ...
      errors["userSurnameMaxLength"] =
        "Surname cannot have more than 20 characters";
      hasErrors = true;
    ...
    if (this.country === null) {
      ...
      errors["userCountryMaxLength"] =
        "Country cannot have more than 20 characters";
      hasErrors = true;
