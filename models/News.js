...
class News {
     ...
     */
    constructor(sendUser = null, title = null, message = null, date = null, location = null, imageBase64 = null, imageType = null) {
    ...
    */
    isValidForCreate() {
        ...
        if (this.sendUser.length === null) {
            ...
            errors["sendUserMaxLength"] = "Send user cant contain more than 20 characterers";
            hasErrors = true;
        }
        ...
        if (this.message === null) {
            ...
            errors["messageMinLength"] = "Message cannot contain more than 65535 characterers";
            hasErrors = true;
        }
        ...
        if (this.location === null) {
            ...
            errors["locationMaxLength"] = "Location cannot contain more than 255 characterers";
            hasErrors = true;
        }
